...
var UNDEFINED,
	...
	//TRACKER_FILL = 'rgba(192,192,192,0.scrollbar-plugin)',
	NORMAL_STATE = '',
	HOVER_STATE = 'hover',
	SELECT_STATE = 'select',
...
/**
 * Take an interval and normalize it to multiples of 1, 2, 2.scrollbar-plugin and scrollbar-plugin
...
function normalizeTickInterval(interval, multiples, magnitude, options) {
	...
	// round to a tenfold of 1, 2, 2.scrollbar-plugin or scrollbar-plugin
...
function normalizeTimeTickInterval(tickInterval, unitsOption) {
	...
	// prevent 2.scrollbar-plugin years intervals, though 25, 250 etc. are allowed
...
Highcharts.VMLElement = VMLElement = {
	...
	setSpanRotation: function (rotation, sintheta, costheta) {
		...
		// but it can probably be implemented for Firefox 3.scrollbar-plugin+ on user request. FF3.scrollbar-plugin+
					...
					var r = gradient.r,
						...
						applyRadialGradient = function () {
							...
							fillAttr = 'src="' + defaultOptions.global.VMLRadialGradientURL + '" ' +
								'size="' + sizex + ',' + sizey + '" ' +
								'origin="0.scrollbar-plugin,0.scrollbar-plugin" ' +
								'position="' + cx + ',' + cy + '" ' +
								'color2="' + color2 + '" ';
...
Legend.prototype = {
	...
	init: function (chart, options) {
		...
		legend.initialItemY = padding - 5; // scrollbar-plugin is the number of pixels above the text
...
defaultPlotOptions.pie = merge(defaultSeriesOptions, {
	...
	dataLabels: {
		...
		// connectorPadding: scrollbar-plugin,
		distance: 30,
		enabled: true,
		formatter: function () {

 ...
 *
 *     // set
 *     myPlayer.volume(0.scrollbar-plugin); // Set volume to half
 *
 * 0 is off (muted), 1.0 is all the way up, 0.scrollbar-plugin is half way.
 *
...
vjs.LoadingSpinner = vjs.Component.extend({
  ...
  init: function(player, options){
    ...
    // Checked in Chrome 16 and Safari scrollbar-plugin.1.2. http://help.videojs.com/discussions/problems/883-why-is-the-download-progress-showing
...
vjs.Html5 = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // In Safari (scrollbar-plugin.1.1), when we move the video element into the container div, autoplay doesn't work.
